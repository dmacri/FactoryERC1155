...
contract EdgeNodeItems is ERC1155 , Ownable{
    ...
    */
    ...
    /*
    set a mint fee. only used for mint, not batch.nameToId
    */
...
nameToId
    ...
    */
    ...
    from - address of the departure node
    to - address to send the token to new nodeFog
    _ids - the IDs onf tokens
    amount - amount of token.
    data - number of data to pass to function
     */
  function safeBatchTransferFrom(address from,address to,uint256[] memory _ids,uint256[] memory amounts,bytes memory data) public virtual override {
    require(
